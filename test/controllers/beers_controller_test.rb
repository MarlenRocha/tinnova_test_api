...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { beer_id: @beer.beer_id, seen_at: @beer.seen_at, user_id: @beer.user_id } }, as: :json
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { beer_id: @beer.beer_id, seen_at: @beer.seen_at, user_id: @beer.user_id } }, as: :json
    assert_response 200
  end
